...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.shop'
        db.add_column(u'ncatalogue_category', 'shop',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='categories', to=orm['shops.Shop']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.shop'
        db.delete_column(u'ncatalogue_category', 'shop_id')

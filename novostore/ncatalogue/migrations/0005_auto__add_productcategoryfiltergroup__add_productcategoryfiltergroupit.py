...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.delete_unique(u'ncatalogue_product', ['upc'])

        # Adding model 'ProductCategoryFilterGroup'
        db.create_table(u'ncatalogue_productcategoryfiltergroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='filtergroups', to=orm['ncatalogue.Category'])),
        ))
        db.send_create_signal(u'ncatalogue', ['ProductCategoryFilterGroup'])

        # Adding model 'ProductCategoryFilterGroupItem'
        db.create_table(u'ncatalogue_productcategoryfiltergroupitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filtergroup', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['ncatalogue.ProductCategoryFilterGroup'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='filtergroupitems', to=orm['ncatalogue.Category'])),
        ))
        db.send_create_signal(u'ncatalogue', ['ProductCategoryFilterGroupItem'])

        # Removing index on 'Product', fields ['text']
        #db.delete_index(u'ncatalogue_product', ['text'])

        # Removing index on 'Product', fields ['long_description']
        #db.delete_index(u'ncatalogue_product', ['long_description'])

        # Removing index on 'MeasureUnit', fields ['description']
        #db.delete_index(u'ncatalogue_measureunit', ['description'])


    def backwards(self, orm):
        # Adding index on 'MeasureUnit', fields ['description']
        db.create_index(u'ncatalogue_measureunit', ['description'])

        # Adding index on 'Product', fields ['long_description']
        db.create_index(u'ncatalogue_product', ['long_description'])

        # Adding index on 'Product', fields ['text']
        db.create_index(u'ncatalogue_product', ['text'])

        # Deleting model 'ProductCategoryFilterGroup'
        db.delete_table(u'ncatalogue_productcategoryfiltergroup')

        # Deleting model 'ProductCategoryFilterGroupItem'
        db.delete_table(u'ncatalogue_productcategoryfiltergroupitem')

        # Adding unique constraint on 'Product', fields ['upc']
        db.create_unique(u'ncatalogue_product', ['upc'])
    ...
    models = {
        ...
        u'ncatalogue.product': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'long_description': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
        ...
        u'ncatalogue.productattachment': {
            'Meta': {'object_name': 'ProductAttachment'},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attachments'", 'to': u"orm['ncatalogue.Product']"})
        },
        u'ncatalogue.productcategoryfiltergroup': {
            'Meta': {'object_name': 'ProductCategoryFilterGroup'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'filtergroups'", 'to': u"orm['ncatalogue.Category']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'db_index': 'True', 'blank': 'True'})
        },
        u'ncatalogue.productcategoryfiltergroupitem': {
            'Meta': {'object_name': 'ProductCategoryFilterGroupItem'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'filtergroupitems'", 'to': u"orm['ncatalogue.Category']"}),
            'filtergroup': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': u"orm['ncatalogue.ProductCategoryFilterGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'ncatalogue.productdetail': {
            'Meta': {'object_name': 'ProductDetail'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'details'", 'to': u"orm['ncatalogue.Product']"}),

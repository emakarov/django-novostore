...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('commerce_deliveryaddress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('street_house', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='delivery_addresses', to=orm['auth.User'])),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('commerce', ['DeliveryAddress'])


    def backwards(self, orm):
        # Deleting model 'DeliveryAddress'
        db.delete_table('commerce_deliveryaddress')
    ...
    models = {
        ...
        'commerce.deliveryaddress': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'delivery_addresses'", 'to': "orm['auth.User']"}),

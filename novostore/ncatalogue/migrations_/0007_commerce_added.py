...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('ncatalogue_currency')


        # Changing field 'Product.currency'
        db.alter_column('ncatalogue_product', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['commerce.Currency']))

    def backwards(self, orm):
        # Adding model 'Currency'
        db.create_table('ncatalogue_currency', (
        ...
        db.send_create_signal('ncatalogue', ['Currency'])


        # Changing field 'Product.currency'
        db.alter_column('ncatalogue_product', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ncatalogue.Currency']))

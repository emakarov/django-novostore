...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountsUser.is_active'
        db.add_column(u'accounts_accountsuser', 'is_active',
    ...
    def backwards(self, orm):
        # Deleting field 'AccountsUser.is_active'
        db.delete_column(u'accounts_accountsuser', 'is_active')

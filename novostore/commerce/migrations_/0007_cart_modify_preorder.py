...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreOrder.modified_at'
        db.add_column('commerce_preorder', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2013, 4, 28, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PreOrder.requested_for_delivery'
        db.add_column('commerce_preorder', 'requested_for_delivery',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PreOrder.payment_on_delivery'
        db.add_column('commerce_preorder', 'payment_on_delivery',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PreOrder.is_active'
        db.add_column('commerce_preorder', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreOrder.modified_at'
        db.delete_column('commerce_preorder', 'modified_at')

        # Deleting field 'PreOrder.requested_for_delivery'
        db.delete_column('commerce_preorder', 'requested_for_delivery')

        # Deleting field 'PreOrder.payment_on_delivery'
        db.delete_column('commerce_preorder', 'payment_on_delivery')

        # Deleting field 'PreOrder.is_active'
        db.delete_column('commerce_preorder', 'is_active')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'shops_client', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.AccountsUser']))

        # Changing field 'Worker.user'
        db.alter_column(u'shops_worker', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.AccountsUser']))

        # Changing field 'Shop.owner'
        db.alter_column(u'shops_shop', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.AccountsUser']))

    def backwards(self, orm):

        # Changing field 'Client.user'
        db.alter_column(u'shops_client', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Worker.user'
        db.alter_column(u'shops_worker', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Shop.owner'
        db.alter_column(u'shops_shop', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

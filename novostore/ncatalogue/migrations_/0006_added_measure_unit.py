...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ncatalogue_measureunit', (
        ...
        db.send_create_signal('ncatalogue', ['MeasureUnit'])

        # Adding field 'Product.measure_unit'
        db.add_column('ncatalogue_product', 'measure_unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ncatalogue.MeasureUnit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MeasureUnit'
        db.delete_table('ncatalogue_measureunit')

        # Deleting field 'Product.measure_unit'
        db.delete_column('ncatalogue_product', 'measure_unit_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Client'
        db.create_table(u'shops_client', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='clients', to=orm['auth.User'])),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='clients', to=orm['shops.Shop'])),
        ))
        db.send_create_signal(u'shops', ['Client'])


    def backwards(self, orm):
        # Deleting model 'Client'
        db.delete_table(u'shops_client')
    ...
    models = {
        ...
        u'shops.shop': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'shops'", 'to': u"orm['auth.User']"}),
        ...
        u'shops.worker': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'worked'", 'to': u"orm['auth.User']"})
        }
    }

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ncatalogue_category', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.description'
        db.delete_column(u'ncatalogue_category', 'description')

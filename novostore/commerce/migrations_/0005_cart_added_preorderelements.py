...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreOrderElement'
        db.create_table('commerce_preorderelement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ncatalogue.Product'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')()),
            ('preorder', self.gf('django.db.models.fields.related.ForeignKey')(related_name='elements', to=orm['commerce.PreOrder'])),
        ))
        db.send_create_signal('commerce', ['PreOrderElement'])

        # Deleting field 'PreOrder.price'
        db.delete_column('commerce_preorder', 'price')
    ...
    def backwards(self, orm):
        # Deleting model 'PreOrderElement'
        db.delete_table('commerce_preorderelement')

        # Adding field 'PreOrder.price'
        db.add_column('commerce_preorder', 'price',

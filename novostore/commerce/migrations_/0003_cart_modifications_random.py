...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart.random_key'
        db.add_column('commerce_cart', 'random_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, db_index=True),
                      keep_default=False)

        # Adding index on 'Cart', fields ['session_key']
        db.create_index('commerce_cart', ['session_key'])


    def backwards(self, orm):
        # Removing index on 'Cart', fields ['session_key']
        db.delete_index('commerce_cart', ['session_key'])

        # Deleting field 'Cart.random_key'
        db.delete_column('commerce_cart', 'random_key')

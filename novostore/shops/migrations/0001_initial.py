...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Worker'
        db.create_table(u'shops_worker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='worked', to=orm['auth.User'])),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='workers', to=orm['shops.Shop'])),
        ))
        db.send_create_signal(u'shops', ['Worker'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'shops_worker')

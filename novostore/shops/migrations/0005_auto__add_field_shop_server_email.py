...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shop.server_email'
        db.add_column(u'shops_shop', 'server_email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shop.server_email'
        db.delete_column(u'shops_shop', 'server_email')
    ...
    models = {
        ...
        u'shops.shop': {
            ...
            'server_email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),

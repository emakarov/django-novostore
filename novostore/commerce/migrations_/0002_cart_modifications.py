...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PreOrder.sale'
        db.delete_column('commerce_preorder', 'sale_id')

        # Deleting field 'PreOrder.coupons_number'
        db.delete_column('commerce_preorder', 'coupons_number')

        # Adding field 'PreOrder.cart'
        db.add_column('commerce_preorder', 'cart',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['commerce.Cart']),
                      keep_default=False)

        # Adding field 'CartElement.cart'
        db.add_column('commerce_cartelement', 'cart',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='elements', to=orm['commerce.Cart']),
                      keep_default=False)

        # Deleting field 'Cart.coupons_purchased'
        db.delete_column('commerce_cart', 'coupons_purchased')

        # Deleting field 'Cart.coupons_left'
        db.delete_column('commerce_cart', 'coupons_left')

        # Adding field 'Cart.session_key'
        db.add_column('commerce_cart', 'session_key',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=100),
                      keep_default=False)

        # Adding field 'Cart.user'
        db.add_column('commerce_cart', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cart.created_at'
        db.add_column('commerce_cart', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 27, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Cart.modified_at'
        db.add_column('commerce_cart', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2013, 4, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PreOrder.sale'
        db.add_column('commerce_preorder', 'sale',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['commerce.Cart']),
                      keep_default=False)

        # Adding field 'PreOrder.coupons_number'
        db.add_column('commerce_preorder', 'coupons_number',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'PreOrder.cart'
        db.delete_column('commerce_preorder', 'cart_id')

        # Deleting field 'CartElement.cart'
        db.delete_column('commerce_cartelement', 'cart_id')

        # Adding field 'Cart.coupons_purchased'
        db.add_column('commerce_cart', 'coupons_purchased',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Cart.coupons_left'
        db.add_column('commerce_cart', 'coupons_left',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Cart.session_key'
        db.delete_column('commerce_cart', 'session_key')

        # Deleting field 'Cart.user'
        db.delete_column('commerce_cart', 'user_id')

        # Deleting field 'Cart.created_at'
        db.delete_column('commerce_cart', 'created_at')

        # Deleting field 'Cart.modified_at'
        db.delete_column('commerce_cart', 'modified_at')
    ...
    models = {
        ...
        'commerce.preorder': {
            ...
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['commerce.Cart']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

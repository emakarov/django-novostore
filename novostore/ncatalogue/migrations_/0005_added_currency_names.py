...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Currency.name_international'
        db.add_column('ncatalogue_currency', 'name_international',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Currency.shortname_international'
        db.add_column('ncatalogue_currency', 'shortname_international',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Currency.name_international'
        db.delete_column('ncatalogue_currency', 'name_international')

        # Deleting field 'Currency.shortname_international'
        db.delete_column('ncatalogue_currency', 'shortname_international')
    ...
    models = {
        ...
        'ncatalogue.product': {
            ...
            'currency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ncatalogue.Currency']"}),

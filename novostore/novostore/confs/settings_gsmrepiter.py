...
INDEX_PAGE_HTML = lambda r: (NCATALOGUE_THEME + '/index.html')
PRODUCT_LIST_HTML = lambda r: (NCATALOGUE_THEME +'/product_list.html')
PRODUCT_PAGE_HTML = lambda r: (NCATALOGUE_THEME +'/product.html')
LOGIN_PAGE_HTML = lambda r: (NCATALOGUE_THEME +'/accounts/login.html')
PROFILE_PAGE_HTML = lambda r: (NCATALOGUE_THEME +'/accounts/profile.html')
SETUP_NEW_PASSWD_PAGE_HTML = lambda r: (NCATALOGUE_THEME +'/accounts/set_up_new_passwd.html')
CART_PAGE_HTML = lambda r: (NCATALOGUE_THEME +'/commerce/cart.html')
CHECKOUT_PAGE_HTML = lambda r: (NCATALOGUE_THEME +'/commerce/checkout.html')
CHECKOUT_CONFIRMED_HTML = lambda r: (NCATALOGUE_THEME + '/commerce/checkout_confirmed.html')
BLOG_INDEX_HTML = lambda r: (NCATALOGUE_THEME + '/blog/index.html')
BLOG_ARTICLELIST_HTML = lambda r: (NCATALOGUE_THEME + '/blog/articlelist.html')
BLOG_ARTICLE_HTML = lambda r: (NCATALOGUE_THEME + '/blog/article.html')

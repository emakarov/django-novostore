...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Lead'
        db.create_table(u'shopleads_lead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='leads', to=orm['shops.Shop'])),
            ('content', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal(u'shopleads', ['Lead'])


    def backwards(self, orm):
        # Deleting model 'Lead'
        db.delete_table(u'shopleads_lead')
    ...
    models = {
        ...
        u'shopleads.lead': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shop': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'leads'", 'to': u"orm['shops.Shop']"})
        },
        u'shops.shop': {

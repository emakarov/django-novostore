...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ncatalogue_productdetail', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='details', to=orm['ncatalogue.Product'])),
        ))
        db.send_create_signal(u'ncatalogue', ['ProductDetail'])

        # Adding model 'ProductAttachment'
        db.create_table(u'ncatalogue_productattachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_index=True, blank=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachments', to=orm['ncatalogue.Product'])),
        ))
        db.send_create_signal(u'ncatalogue', ['ProductAttachment'])


    def backwards(self, orm):
        # Deleting model 'ProductDetail'
        db.delete_table(u'ncatalogue_productdetail')

        # Deleting model 'ProductAttachment'
        db.delete_table(u'ncatalogue_productattachment')

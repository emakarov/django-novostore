...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lead.received'
        db.add_column(u'shopleads_lead', 'received',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lead.received'
        db.delete_column(u'shopleads_lead', 'received')
    ...
    models = {
        ...
        u'shopleads.lead': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'received': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
